...
ok(!["CLAUDE.md", "CLAUDE.local.md", "STATUS.md", "STATUS.full.md", ".shipkit/reflections/x.md", "site/x.md", "node_modules/a/README.md", "asks/001-x.md", "params.json"].some(est_publie), "jamais publies : CLAUDE*, STATUS*, dossiers caches, site/, node_modules, asks/ (la file des actions de Rémi)");
