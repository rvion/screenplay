...
ok($$("#vignettes button[data-vue] canvas").length === 6 && $$("#vignettes button").map((b) => b.dataset.vue).join() === "jardin,droite,arriere,porte,interieur,couche" && $("#vignettes").previousElementSibling.classList.contains("fiche-vue"), "six vignettes sous les deux colonnes du résumé, la première est la vue de départ");
