...
ok($$("#vignettes button[data-vue] canvas").length === 8 && $$("#vignettes button").map((b) => b.dataset.vue).join() === "jardin,droite,arriere,porte,interieur,lit,lit2,lit3" && $("#vignettes").previousElementSibling.classList.contains("fiche-vue"), "huit vignettes sous les deux colonnes du résumé, la première est la vue de départ");
