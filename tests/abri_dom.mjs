...
ok($$("#questions-corps .pourquoi-bloc:last-child .question").length >= 9 && $$("#questions-corps .pourquoi-bloc:last-child .question")[0].textContent === "I1" && $$("#questions-corps .pourquoi-bloc:last-child li b").length >= 9 && $("#questions-corps .pourquoi-bloc:last-child").textContent.includes("porte " + String(Math.floor(m.portee_cm / 10) / 10).replace(".", ",") + " m sans panne") && !/columns: 2/.test(readFileSync(join(ROOT, "site/abri.css"), "utf8").split("ol.questions")[1].split("}")[0]), "idées : un second bloc I1.., accroche en gras, chiffres injectés, liste simple sans colonnes de texte");
