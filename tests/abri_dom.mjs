...
ok($("#fiche-chantier h2").textContent === "Résumé" && $$("#fiche .resume-figs figure svg").length === 1 && $$("#fiche dl dt").length === 4 && /TTC/.test($("#fiche").textContent), "résumé : un seul dessin et quatre lignes de chiffres");
...
ok($$("#vignettes button[data-vue] canvas").length === 3 && $$("#vignettes button").map((b) => b.dataset.vue).join() === "porte,arriere,droite", "trois vignettes 3D sous la vue principale : porte, arrière, droite");
