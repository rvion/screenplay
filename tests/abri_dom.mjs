...
ok($$("#vignettes button[data-vue] canvas").length === 9 && $$("#vignettes button").map((b) => b.dataset.vue).join() === "jardin,droite,arriere,porte,interieur,lit,lit2,lit3,lit4" && $("#vignettes").previousElementSibling.classList.contains("fiche-vue"), "neuf vignettes sous les deux colonnes du résumé, la première est la vue de départ");
