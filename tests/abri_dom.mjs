...
ok($$("#vignettes button[data-vue] canvas").length === 7 && $$("#vignettes button").map((b) => b.dataset.vue).join() === "jardin,porte,arriere,droite,interieur,lit,lit2" && $("#vignettes").previousElementSibling.classList.contains("fiche-vue"), "sept vignettes sous les deux colonnes du résumé, la première est la vue de départ");
