...
ok($("#questions h2").textContent === "Questions et idées" && $("#pourquoi").nextElementSibling === $("#questions") && $$("#questions-corps .pourquoi-bloc").length === 2 && $$("#questions-corps ol.questions").every((o) => o.closest(".pourquoi-bloc")) && $$("#questions-corps .pourquoi-bloc:first-child .question").map((q) => q.textContent).join() === "Q1,Q2,Q3,Q4,Q5" && $$("#questions-corps .pourquoi-bloc:first-child li").every((li) => /\?$/.test(li.textContent.trim())) && $("#questions-corps").textContent.includes(String(m.pente.pourcent).replace(".", ",") + " %"), "questions : leur section sous « pourquoi », un bloc de questions Q1..Q5 en liste simple, chacune finit par « ? »");
