...
ok(["toit", "mobilier", "lit", "etiquettes", "sieges"].every((k) => groupes[k]) && groupes.lit.visible === false && groupes.toit.visible === true, "groupes masquables : toit, mobilier, lit (cache au depart), etiquettes, sieges");
