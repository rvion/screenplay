...
ok(JSON.stringify([VUES.dedans.position, VUES.dedans.cible, VUES.dedans.fov]) === "[[3.7,3.73,-1.67],[-0.2,1.09,0.1],42]" && JSON.stringify(VUES.dedans.etats) === JSON.stringify({ toit: 0, murs: 4, porte: 0, mobilier: 1, etiquettes: 0, personne: 2, cloture: 2 }), "vue dedans : par le côté porte ouvert (sans D ni C), assis au bureau, sans toit ni palissade");
