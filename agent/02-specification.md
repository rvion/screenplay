...
| `site/assets/modele-implantation.svg` | l'abri retenu **sur la dalle réelle** (côtés, angles, murs de propriété), toit et gouttière, distances aux bords de la dalle, passages derrière, **gaine électrique** (`dalle_cm.gaine_electrique` : trou de la dalle, dit s'il tombe sous un mur, dans l'abri ou dehors ; en 3D un tube rouge de son diamètre qui sort de la dalle) ; première image d'`abri.md` |
