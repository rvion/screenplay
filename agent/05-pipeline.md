...
│   ├── variantes.md   #   FIGÉE le 2026-09-22 : les 13 formes d'abri sur la dalle, plans dans site/assets/etudes/variantes/
...
└── site/               # GitHub Pages (publié tel quel)
    ...
    └── assets/         # GÉNÉRÉS : plan-dalle, modele-* (.svg) ; etudes/ = plans figés (vN/, variantes/, formes/)
```
