...
window.SHED_PARAMS = {
  ...
  "abri_v2": {
    ...
    "params": {
      ...
      "rehausse": {
        ...
        "_comment": "les madriers classe 4 se vendent en 4 m ou 4,5 m, pas en 4,8 m"
      },
      "disposition_trapeze": {
        "cotes_cm": {
          "avant": 200,
    ...
    "hors_modele": [
      ...
      "Monter le **mur gauche à plat puis le lever** (3 panneaux + rehausse, environ 80 kg) : à {gauche_cm} cm du grillage de la limite, aucune visseuse ne passe. Fermer ce vide par une bavette devant et un grillage au fond (feuilles, nids).",
  ...
  "abri_v3": {
    ...
    "atouts": [
      ...
      "Tout ce que la version 2 apporte reste vrai ici : porte pleine sur le côté, à l'abri des regards de l'étage voisin ; lumière de côté sur les écrans du bureau gauche ; toit vers le jardin, portée de 2 m, madrier courant. Voir [abri-v2.md](etudes/abri-v2.md)."
    ],
    "pertes": [
    ...
    "hors_modele": [
      ...
      "Même sans formalité, vérifier au PLU la règle d'implantation par rapport à la limite (à {gauche_cm} cm de la limite, l'abri n'est ni en limite ni à 3 m)."
    ]
  },
  "abri_v4": {
    "nom_court": "cinq murs, toit vers le fond, gouttière derrière",
    "_dossier_comment": "Textes de la section « Pourquoi cette forme » de la page d'accueil : autonomes (aucune comparaison avec une autre version), champs {…} calcules. atouts = points forts, limites = points faibles, questions = ce qui reste a trancher (numerotees Q1, Q2… par la page).",
    "dossier": {
      "atouts": [
      ...
      "questions": [
        ...
        "Fenêtres : 80 × 80 sur mesure (4 à 5 semaines), ou 80 × 75 de stock ?",
      ...
      "idees": [
        "**Deux fenêtres identiques.** Les deux oscillo-battantes, ou les deux fixes avec une grille de ventilation à part : une seule référence, une seule découpe, un seul délai.",
        "**Fenêtre fixe sans châssis.** Un double vitrage posé sur parcloses bois dans la découpe du panneau, comme dans les tiny houses : moins cher qu'un châssis PVC, aucun délai, et le cadre bois ferme la tranche du panneau.",
  ...
  "prix_materiaux_eur_ttc": {
    ...
    "fenetre_ob_u": {
      "pu": 155,
      "unite": "u",
      "source": "https://www.fenetre24.com/fenetre-pvc-80x80-cm.php",
      "note": "80 x 80 sur mesure a partir de 155 EUR, port en plus. En stock : 80 de large x 75 de haut (2 vantaux) 119 EUR, x 105 de haut 129 EUR (Brico Depot)."
    },
    "gouttiere_ml": {
      "pu": 4.7,
      "unite": "ml",
