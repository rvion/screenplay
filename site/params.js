...
window.SHED_PARAMS = {
  ...
  "abri": {
    ...
    "dossier": {
      "atouts": [
        "**Cinq murs, aucun angle aigu.** Deux angles proches de 135°, un seul mur en biais ({pan_cm} cm), fait d'un seul panneau.",
      ...
      "questions": [
        ...
        "Quelle est la hauteur réelle de la palissade du grand pan, que le débord arrière doit dégager ?",
        "Où va l'eau de la descente : au jardin par un tuyau au sol le long de la limite, ou dans un récupérateur au coin arrière gauche ?"
      ],
      "idees": [
        "**Toit en 80 ou 100 mm.** Un panneau plus épais porte {portee_m} m sans doute possible : plus de question de panne, contre un panneau un peu plus cher.",
        ...
        "**Rehausse plus basse.** Si le fabricant admet une pente plus faible, un madrier moins haut : bois moins cher, façade plus basse, moins de prise au vent.",
  ...
  "dalle_cm": {
    "_comment": "Dalle REELLE deja coulee, relevee au metre : pentagone a pointe arriere. 5 longueurs : avant, droite, gauche, puis les deux pans arriere qui se rejoignent en pointe (arriere_gauche part du haut du cote gauche, arriere_droite arrive en haut du cote droit). La pointe est calculee par triangulation (~73 ; 398), angles avant supposes droits. Mesure de controle : 260 de large a hauteur du coin droit. murs_mitoyens = cotes qui sont la limite de propriete (infranchissables) : gauche et les deux pans arriere ; l'avant et la droite donnent sur le jardin. mur_hauteur_cm / mur_epaisseur_cm : HYPOTHESES pour le dessin 3D, a mesurer. passage_souhaite_cm = passage vise derriere l'abri, mesure sur la forme (v.passages).",
    "avant": 262,
    "droite": 223,
    "gauche": 324,
    "arriere_gauche": 104,
  ...
  "disposition_trapeze": {
    "_comment": "Amenagement de l'option 13 (trapeze, passage vise derriere) : cotes_cm impose les murs (sans elles, le mur droit recule jusqu'a interieur_vise_m2), porte de porte_largeur_cm (ouverture) sur le cote droit, entouree d'un chambranle de porte_chambranle_cm, le cadre a porte_marge_cm des faces interieures des murs voisins et sous le haut du mur (hauteur de passage = hauteur du mur - marge - chambranle), bureaux le long des murs nommes dans bureaux, facade = fenetres seulement ; sieges = emprise au sol posee contre le bord interieur d'un bureau (contre), sur la plus longue partie libre de ce bord (position = centre|debut|fin ou decalage en cm) ; lits_muraux = le lit a demeure (voir _comment_lits_muraux) ; fenetres : position = gauche|centre|droite le long du cote ou distance en cm depuis le debut du cote, une par panneau, jamais sur un joint.",
    "interieur_vise_m2": 4.8,
    "porte_cote": "droite",
    "porte_position": "droite",
    "porte_largeur_cm": 70,
    "porte_chambranle_cm": 0,
    "porte_marge_cm": 10,
    "toit": {
      "sens": "arriere",
      "chute_cm": 22,
    ...
    "lisse_stock_cm": 450,
    "_lisse_comment": "Lisse haute : une lambourde 45 x 70 classe 4 posee a plat sur la tete de CHAQUE mur (largeur, hauteur en mm), la rehausse vissee dessus. Le bas du toit porte sur elle au fond, ou il n'y a pas de rehausse. Deux epaisseurs de la meme lambourde font le seuil de la porte, au niveau du plancher flottant.",
    "bureaux": [
      {
        "cote": "gauche",
        "profondeur_cm": 70
    ...
    "_comment_lits_muraux": "le lit de l'abri, pose a demeure contre le mur `contre` et cale a l'autre bout (position 'fin') ; tete = cote de l'oreiller ; bureaux = ceux qui restent, reduits au plus grand morceau hors du lit, sauf bureaux_entiers : le plateau (72 cm) passe AU-DESSUS du pied du lit (55 cm) et reste entier ; les sieges se rangent dessous, jamais sur le lit. Ici : lit 80 x 190 le long de la facade (196 dedans), tete contre le mur de la porte, pieds vers le bureau gauche et ses ecrans",
    "porte_hauteur_cm": 200
  },
  "formes_etudiees": [
    {
      "type": "commerce",
  ...
  "prix_materiaux_eur_ttc": {
    ...
    "lambourde_ml": {
      "pu": 4.2,
      "unite": "ml",
      "source": "https://www.depotbois.com/product-page/lambourde-pin-classe-4-70x45mm",
      "note": "lambourde pin classe 4 70 x 45 : 18,90 EUR les 4,5 m, 12,90 EUR les 3 m ; Brico Depot la vend aussi en 2,7 et 3 m"
    },
    "madrier_ml": {
      "pu": 14.7,
      "unite": "ml",
