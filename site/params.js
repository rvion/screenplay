...
window.SHED_PARAMS = {
  ...
  "abri": {
    ...
    "dossier": {
      ...
      "questions": [
        ...
        "Porte : le bloc intérieur de 73 (160 €) tient-il dehors sous le débord, ou faut-il un bloc de service extérieur de 80 (199 €) ?",
  ...
  "prix_materiaux_eur_ttc": {
    ...
    "porte_pleine_u": {
      ...
      "note": "bloc-porte fin de chantier Artens Lia 204 x 73, reversible, bati reglable 50 a 100 mm, serrure a cle, poignee a part. Reservation 79,3 x 207,6 : le cadre bois de 83 x 209 la contient. ATTENTION c'est une porte INTERIEURE (ame alveolaire, pas d'isolation ni d'etancheite) : la proteger par un debord de toit et un seuil, ou lui preferer un bloc-porte de service exterieur (205 x 80 PVC, 199 EUR)"
    },
    "porte_vitree_u": {
      "pu": 900,
      "unite": "u",
