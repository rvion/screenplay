...
window.SHED_PARAMS = {
  ...
  "abri_v3": {
    "_comment": "Version 3 = version 2 (herite) + un cinquieme mur : le fond d'equerre sur un module, puis un pan a 45 degres jusqu'au haut du mur droit ; l'ecart de {gauche_cm} cm au bord gauche de la dalle est celui de la version 2. compare_a = la version a laquelle abri-v3.md se compare. Les {champs} des textes sont remplaces par des valeurs calculees.",
    "herite": "abri_v2",
    "compare_a": 2,
    ...
    "atouts": [
      ...
      "**Le pan à 45° longe le mur de propriété** (incliné à 42,8°) : le passage derrière garde une largeur presque constante au lieu de s'ouvrir en entonnoir. Au plus étroit il fait {passage_cm} cm, contre {base_passage_cm} cm dans la version 2 : c'est le cinquième mur qui prend la différence. **À vérifier avec la tondeuse avant de choisir.**",
      "**{gauche_cm} cm contre le bord gauche, comme la version 2** : assez pour fermer le vide proprement (bavette devant, grillage au fond) et pour que l'eau et les feuilles ne restent pas coincées. À 5 cm le passage derrière gagnerait 3 à 4 cm, mais le vide deviendrait impossible à traiter.",
    ...
    "notes": [
      ...
      "**{gauche_cm} cm à gauche** : le mur gauche se monte à plat puis se lève (voir les conseils de la version 2), on ne visse rien dans ce vide. Il faut le fermer devant par une bavette et au fond par un grillage.",
    ...
    "hors_modele": [
      ...
      "Avant de déposer la déclaration préalable, vérifier au PLU la règle d'implantation par rapport à la limite (à {gauche_cm} cm du mur de propriété, l'abri n'est ni en limite ni à 3 m)."
    ]
  },
  "abri_v4": {
    ...
    "pertes": [
      ...
      "**Pente {pente_pourcent} % au lieu de {base_pente_pourcent} %** : la même chute de 22,5 cm s'étale sur 3 m au lieu de 2 m. C'est peu pour une toiture en panneaux ; une chute de 30 cm donnerait 10 %, mais demande un madrier de 300, introuvable en stock (ou deux pièces superposées).",
