...
> Généré par `npm run emit` depuis `params.json` (bloc `abri_v3`) et `site/src/compute.ts` : ne pas éditer à la main. Autres versions : [version 1](abri-v1.md), [version 2](abri-v2.md), [version 4](abri-v4.md). Autres formes étudiées : [variantes.md](variantes.md).
