# Abri de jardin : le bureau trapèze

> Généré par `npm run emit` depuis `params.json` et `site/src/compute.ts` : ne pas éditer à la main. Autres formes étudiées : [variantes.md](variantes.md).
...
| Panneaux sandwich toit 60 mm (à longueur) | 8,25 m² | 35 € | 289 € |
